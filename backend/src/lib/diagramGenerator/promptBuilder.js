...
[healthcare] KOTLIN, SWIFT, REACT, GO, FASTAPI, JAVA, PYTHON, KEYCLOAK, POSTGRESQL, REDIS, CLICKHOUSE, KAFKA, S3, TWILIO, CLOUDFLARE, KUBERNETES, VAULT, ARGOCD, PROMETHEUS, GRAFANA. Use separate semantic services for API gateway, appointments, EHR access, lab orders, prescription routing, claims processing, prior authorization, consent, billing, fraud, notifications, immutable audit logs, offline clinic sync, and analytics. Model labs, insurers, pharmacies, and hospital EHR systems as external integrations. Include HIPAA boundaries, PHI encryption, dead-letter recovery, regional data residency, and operations monitoring.
