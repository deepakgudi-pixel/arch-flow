...
const FIXTURE_MAP = {
  ...
  'VITESST': { category: 'database', icon: 'database' },
...
database=POSTGRESQL,MYSQL,MONGODB,REDIS,CASSANDRA,DYNAMODB,ELASTICSEARCH,COCKROACHDB,MEMCACHED,NEO4J,SQLITE,MARIADB,CLICKHOUSE,TIMESCALEDB,VITESST,BIGTABLE,AURORA,ROCKSDB
...
YouTube=REACT,GO,PYTHON,VITESST,BIGTABLE,REDIS,KAFKA,CDN,PROMETHEUS
