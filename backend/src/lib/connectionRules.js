export const canonicalConnectionRules = [
  ...
  // Backend -> everything (backend is the hub)
  ...
  // Database -> limited (databases are passive)
  ...
  // Queue -> limited (queues are passive consumers)
  ...
  ['external', 'storage', false, 'External services should not connect to storage directly.'],
