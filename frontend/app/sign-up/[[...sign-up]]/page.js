...
import { ArrowRight, Terminal, Shield, Activity, UserPlus } from 'lucide-react';
        ...
        <div>
          ...
          <Hero>
            <StatusTag>
              ...
              Registration Open // Layer 0.1
            </StatusTag>
            <Title>
              <ScrambleText text="INITIALIZE" delay={200} />
              <br />
              <ScrambleText text="SYSTEM_ENTRY" delay={800} />
            </Title>
            <motion.p
            ...
            >
              Secure your terminal access. Join the network of architects building the next generation of industrial-grade system models.
            </motion.p>
          </Hero>

          <MetaGrid>
            {[
              { icon: <Terminal size={14} />, label: 'New_Entry', value: 'PENDING_AUTH' },
              { icon: <Shield size={14} />, label: 'Protocol', value: 'SECURE_NODE' },
              { icon: <UserPlus size={14} />, label: 'Access_Level', value: 'L1_ARCHITECT' },
              { icon: <ArrowRight size={14} />, label: 'Destination', value: '/DASHBOARD' },
            ].map((item, i) => (
              <MetaItem
                key={i}
